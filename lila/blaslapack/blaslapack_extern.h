...
#else
extern "C" blas_scomplex_t
cdotc_(const blas_size_t *N, const blas_scomplex_t *x, const blas_size_t *incx,
       const blas_scomplex_t *y, const blas_size_t *incy);
extern "C" blas_complex_t zdotc_(const blas_size_t *N, const blas_complex_t *x,
...
// Linear Solve
// Gesv
extern "C" lapack_ret_t sgesv_(LAPACK_CONST blas_size_t *n,
                               LAPACK_CONST blas_size_t *n_rhs, blas_float_t *A,
                               LAPACK_CONST blas_size_t *lda, blas_size_t *ipiv,
                               blas_float_t *B, LAPACK_CONST blas_size_t *ldb,
                               int *info);
extern "C" lapack_ret_t dgesv_(LAPACK_CONST blas_size_t *n,
...
cgesv_(LAPACK_CONST blas_size_t *n, LAPACK_CONST blas_size_t *n_rhs,
       blas_scomplex_t *A, LAPACK_CONST blas_size_t *lda, blas_size_t *ipiv,
       blas_scomplex_t *B, LAPACK_CONST blas_size_t *ldb, int *info);
extern "C" lapack_ret_t zgesv_(LAPACK_CONST blas_size_t *n,
                               LAPACK_CONST blas_size_t *n_rhs,
...
extern "C" lapack_ret_t sgetrf_(LAPACK_CONST blas_size_t *M,
                                LAPACK_CONST blas_size_t *N, blas_float_t *A,
                                LAPACK_CONST blas_size_t *lda,
                                blas_size_t *ipiv, blas_size_t *info);
extern "C" lapack_ret_t dgetrf_(LAPACK_CONST blas_size_t *M,
                                LAPACK_CONST blas_size_t *N, blas_double_t *A,
                                LAPACK_CONST blas_size_t *lda,
                                blas_size_t *ipiv, blas_size_t *info);
extern "C" lapack_ret_t cgetrf_(LAPACK_CONST blas_size_t *M,
                                LAPACK_CONST blas_size_t *N, blas_scomplex_t *A,
                                LAPACK_CONST blas_size_t *lda,
                                blas_size_t *ipiv, blas_size_t *info);
extern "C" lapack_ret_t zgetrf_(LAPACK_CONST blas_size_t *M,
...
sgetrs_(LAPACK_CONST char *trans, LAPACK_CONST blas_size_t *n,
        ...
        blas_float_t *B, LAPACK_CONST blas_size_t *ldb, blas_size_t *info);
extern "C" lapack_ret_t
dgetrs_(LAPACK_CONST char *trans, LAPACK_CONST blas_size_t *n,
        LAPACK_CONST blas_size_t *n_rhs, LAPACK_CONST blas_double_t *A,
        LAPACK_CONST blas_size_t *lda, LAPACK_CONST blas_size_t *ipiv,
        blas_double_t *B, LAPACK_CONST blas_size_t *ldb, blas_size_t *info);
extern "C" lapack_ret_t
cgetrs_(LAPACK_CONST char *trans, LAPACK_CONST blas_size_t *n,
        LAPACK_CONST blas_size_t *n_rhs, LAPACK_CONST blas_scomplex_t *A,
        LAPACK_CONST blas_size_t *lda, LAPACK_CONST blas_size_t *ipiv,
        blas_scomplex_t *B, LAPACK_CONST blas_size_t *ldb, blas_size_t *info);
extern "C" lapack_ret_t
zgetrs_(LAPACK_CONST char *trans, LAPACK_CONST blas_size_t *n,
        LAPACK_CONST blas_size_t *n_rhs, LAPACK_CONST blas_complex_t *A,
        LAPACK_CONST blas_size_t *lda, LAPACK_CONST blas_size_t *ipiv,
        blas_complex_t *B, LAPACK_CONST blas_size_t *ldb, blas_size_t *info);

// Getri (computes inverse from LU Decomposition)
extern "C" lapack_ret_t
sgetri_(LAPACK_CONST blas_size_t *N, blas_float_t *A,
        LAPACK_CONST blas_size_t *lda, LAPACK_CONST blas_size_t *IPIV,
        blas_float_t *WORK, LAPACK_CONST blas_size_t *lwork, blas_size_t *INFO);
extern "C" lapack_ret_t dgetri_(LAPACK_CONST blas_size_t *N, blas_double_t *A,
                                LAPACK_CONST blas_size_t *lda,
                                LAPACK_CONST blas_size_t *IPIV,
                                blas_double_t *WORK,
                                LAPACK_CONST blas_size_t *lwork,
                                blas_size_t *INFO);
extern "C" lapack_ret_t cgetri_(LAPACK_CONST blas_size_t *N, blas_scomplex_t *A,
                                LAPACK_CONST blas_size_t *lda,
                                LAPACK_CONST blas_size_t *IPIV,
                                blas_scomplex_t *WORK,
                                LAPACK_CONST blas_size_t *lwork,
                                blas_size_t *INFO);
extern "C" lapack_ret_t zgetri_(LAPACK_CONST blas_size_t *N, blas_complex_t *A,
                                LAPACK_CONST blas_size_t *lda,
                                LAPACK_CONST blas_size_t *IPIV,
                                blas_complex_t *WORK,
                                LAPACK_CONST blas_size_t *lwork,
...
sgeqrf_(LAPACK_CONST blas_size_t *m, LAPACK_CONST blas_size_t *n,
        blas_float_t *A, LAPACK_CONST blas_size_t *lda, blas_float_t *tau,
        blas_float_t *work, LAPACK_CONST blas_size_t *lwork, blas_size_t *info);
extern "C" lapack_ret_t dgeqrf_(LAPACK_CONST blas_size_t *m,
                                LAPACK_CONST blas_size_t *n, blas_double_t *A,
                                LAPACK_CONST blas_size_t *lda,
                                blas_double_t *tau, blas_double_t *work,
                                LAPACK_CONST blas_size_t *lwork,
                                blas_size_t *info);
extern "C" lapack_ret_t cgeqrf_(LAPACK_CONST blas_size_t *m,
                                LAPACK_CONST blas_size_t *n, blas_scomplex_t *A,
                                LAPACK_CONST blas_size_t *lda,
                                blas_scomplex_t *tau, blas_scomplex_t *work,
                                LAPACK_CONST blas_size_t *lwork,
                                blas_size_t *info);
extern "C" lapack_ret_t zgeqrf_(LAPACK_CONST blas_size_t *m,
                                LAPACK_CONST blas_size_t *n, blas_complex_t *A,
                                LAPACK_CONST blas_size_t *lda,
...
extern "C" lapack_ret_t spotrf_(LAPACK_CONST char *uplo,
                                LAPACK_CONST blas_size_t *n, blas_float_t *A,
                                LAPACK_CONST blas_size_t *lda,
                                blas_size_t *info);

extern "C" lapack_ret_t dpotrf_(LAPACK_CONST char *uplo,
                                LAPACK_CONST blas_size_t *n, blas_double_t *A,
                                LAPACK_CONST blas_size_t *lda,
                                blas_size_t *info);

extern "C" lapack_ret_t cpotrf_(LAPACK_CONST char *uplo,
                                LAPACK_CONST blas_size_t *n, blas_scomplex_t *A,
                                LAPACK_CONST blas_size_t *lda,
                                blas_size_t *info);

extern "C" lapack_ret_t zpotrf_(LAPACK_CONST char *uplo,
                                LAPACK_CONST blas_size_t *n, blas_complex_t *A,
                                LAPACK_CONST blas_size_t *lda,
                                blas_size_t *info);
...
// symmetric/hermitian
extern "C" lapack_ret_t ssyev_(LAPACK_CONST char *jobz, LAPACK_CONST char *uplo,
                               LAPACK_CONST blas_size_t *n, blas_float_t *a,
...
extern "C" lapack_ret_t dsyev_(LAPACK_CONST char *jobz, LAPACK_CONST char *uplo,
                               LAPACK_CONST blas_size_t *n, blas_double_t *a,
...
extern "C" lapack_ret_t cheev_(LAPACK_CONST char *jobz, LAPACK_CONST char *uplo,
                               LAPACK_CONST blas_size_t *n, blas_scomplex_t *a,
                               LAPACK_CONST blas_size_t *lda, blas_float_t *w,
                               blas_scomplex_t *work,
                               LAPACK_CONST blas_size_t *lwork,
...
extern "C" lapack_ret_t zheev_(LAPACK_CONST char *jobz, LAPACK_CONST char *uplo,
                               LAPACK_CONST blas_size_t *n, blas_complex_t *a,
                               LAPACK_CONST blas_size_t *lda, blas_double_t *w,
                               blas_complex_t *work,
                               LAPACK_CONST blas_size_t *lwork,
...
sgeev_(LAPACK_CONST char *jobvl, LAPACK_CONST char *jobvr,
       LAPACK_CONST blas_size_t *n, blas_float_t *a,
       LAPACK_CONST blas_size_t *lda, blas_float_t *wr, blas_float_t *wi,
       blas_float_t *vl, LAPACK_CONST blas_size_t *ldvl, blas_float_t *vr,
...
dgeev_(LAPACK_CONST char *jobvl, LAPACK_CONST char *jobvr,
       LAPACK_CONST blas_size_t *n, blas_double_t *a,
       LAPACK_CONST blas_size_t *lda, blas_double_t *wr, blas_double_t *wi,
       blas_double_t *vl, LAPACK_CONST blas_size_t *ldvl, blas_double_t *vr,
       LAPACK_CONST blas_size_t *ldvr, blas_double_t *work,
       LAPACK_CONST blas_size_t *lwork, blas_size_t *info);
extern "C" lapack_ret_t
cgeev_(LAPACK_CONST char *jobvl, LAPACK_CONST char *jobvr,
       LAPACK_CONST blas_size_t *n, blas_scomplex_t *a,
       LAPACK_CONST blas_size_t *lda, blas_scomplex_t *w, blas_scomplex_t *vl,
       LAPACK_CONST blas_size_t *ldvl, blas_scomplex_t *vr,
       LAPACK_CONST blas_size_t *ldvr, blas_scomplex_t *work,
       LAPACK_CONST blas_size_t *lwork, blas_float_t *rwork, blas_size_t *info);
extern "C" lapack_ret_t
zgeev_(LAPACK_CONST char *jobvl, LAPACK_CONST char *jobvr,
       LAPACK_CONST blas_size_t *n, blas_complex_t *a,
       LAPACK_CONST blas_size_t *lda, blas_complex_t *w, blas_complex_t *vl,
       LAPACK_CONST blas_size_t *ldvl, blas_complex_t *vr,
       LAPACK_CONST blas_size_t *ldvr, blas_complex_t *work,
       LAPACK_CONST blas_size_t *lwork, blas_double_t *rwork,
       blas_size_t *info);

// Real symmetric tridiagonal eigensolvers
extern "C" lapack_ret_t sstev_(LAPACK_CONST char *jobz,
                               LAPACK_CONST blas_size_t *N, blas_float_t *D,
                               blas_float_t *E, blas_float_t *Z,
                               LAPACK_CONST blas_size_t *ldz,
                               blas_float_t *work, blas_size_t *info);

extern "C" lapack_ret_t dstev_(LAPACK_CONST char *jobz,
                               LAPACK_CONST blas_size_t *N, blas_double_t *D,
...
ssygv_(LAPACK_CONST blas_size_t *itype, LAPACK_CONST char *jobz,
       LAPACK_CONST char *uplo, LAPACK_CONST blas_size_t *N, blas_float_t *A,
       LAPACK_CONST blas_size_t *lda, blas_float_t *B,
       LAPACK_CONST blas_size_t *ldb, blas_float_t *W, blas_float_t *work,
       LAPACK_CONST blas_size_t *lwork, blas_size_t *info);

extern "C" lapack_ret_t
dsygv_(LAPACK_CONST blas_size_t *itype, LAPACK_CONST char *jobz,
       LAPACK_CONST char *uplo, LAPACK_CONST blas_size_t *N, blas_double_t *A,
       LAPACK_CONST blas_size_t *lda, blas_double_t *B,
       LAPACK_CONST blas_size_t *ldb, blas_double_t *W, blas_double_t *work,
       LAPACK_CONST blas_size_t *lwork, blas_size_t *info);

extern "C" lapack_ret_t
chegv_(LAPACK_CONST blas_size_t *itype, LAPACK_CONST char *jobz,
       LAPACK_CONST char *uplo, LAPACK_CONST blas_size_t *N, blas_scomplex_t *A,
       LAPACK_CONST blas_size_t *lda, blas_scomplex_t *B,
       LAPACK_CONST blas_size_t *ldb, blas_float_t *W, blas_scomplex_t *work,
       LAPACK_CONST blas_size_t *lwork, blas_float_t *rwork, blas_size_t *info);

extern "C" lapack_ret_t zhegv_(LAPACK_CONST blas_size_t *itype,
                               LAPACK_CONST char *jobz, LAPACK_CONST char *uplo,
                               LAPACK_CONST blas_size_t *N, blas_complex_t *A,
                               LAPACK_CONST blas_size_t *lda, blas_complex_t *B,
                               LAPACK_CONST blas_size_t *ldb, blas_double_t *W,
                               blas_complex_t *work,
                               LAPACK_CONST blas_size_t *lwork,
                               blas_double_t *rwork, blas_size_t *info);
