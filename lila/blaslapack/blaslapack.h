...
namespace lila { 
  namespace blaslapack {
    ...
    inline void potrf(LAPACK_CONST char* uplo, LAPACK_CONST blas_size_t* n, blas_float_t* A,
		      LAPACK_CONST blas_size_t* lda, blas_size_t* info)
    { __LAPACK_ROUTINE_NAME(spotrf)(uplo, n, A, lda, info); }

    inline void potrf(LAPACK_CONST char* uplo, LAPACK_CONST blas_size_t* n, blas_double_t* A,
		      LAPACK_CONST blas_size_t* lda, blas_size_t* info)
    { __LAPACK_ROUTINE_NAME(dpotrf)(uplo, n, A, lda, info); }

    inline void potrf(LAPACK_CONST char* uplo, LAPACK_CONST blas_size_t* n, blas_scomplex_t* A,
		      LAPACK_CONST blas_size_t* lda, blas_size_t* info)
    { __LAPACK_ROUTINE_NAME(cpotrf)(uplo, n, A, lda, info); }

    inline void potrf(LAPACK_CONST char* uplo, LAPACK_CONST blas_size_t* n, blas_complex_t* A,
		      LAPACK_CONST blas_size_t* lda, blas_size_t* info)
