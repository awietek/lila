 ...
 */
template <class coeff_t> inline coeff_t string2number(const std::string &str);
...
string2number<std::complex<float>>(const std::string &str) {
...
string2number<std::complex<double>>(const std::string &str) {
  std::istringstream is(str);
